...
@section('content')
    ...
    <div class="col s12 m-8 center-align">
        <iframe frameborder='0' width='492x' style='border:0px transparent none; overflow:hidden;' height='62px' src='https://www.vrisko.gr/GraphLink/taxcode'></iframe><a href='https://www.vrisko.gr/afm-etairies' style='display: block;height: 14px;left:277px;margin-top: -18px;position: relative;width: 53px;' target='_blank'></a>
    </div>
@endsection
